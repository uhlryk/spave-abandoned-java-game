...
public class HudShieldBar extends Bar {
	...
	public void init(int maxVal){	
		...
		this.setFullBar(_gameAssetAtlas.createSpriteBarShield());
		this.setMaxVal(maxVal);
		GameAssetAtlas gameAssetAtlas=new GameAssetAtlas();
		_icon=gameAssetAtlas.createSpriteResource(GameAssetAtlas.RESOURCE_SHIELD);
		_icon.setSize(45,45);
	}
	@Override
