...
public class TurretResource extends Resource {
	private Array<XmlReader.Element> _xmlMap;
	private Map<Integer,UnitParams> _map;
	@Override
	public String getResourceName() {
		return "data/turret.xml";
	}
	public void init(){
		super.init();
		_xmlMap=this.getXmlObject().getChildrenByName("turret");
	 ...
	 * @return
	 */
	public Map<Integer,UnitParams> getTurretMap(){
		return _map;
	}
	/**
	 ...
	 * @return
	 */
	public UnitParams getTurret(int turretId){
